...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="pic.jpg" alt="Sharan" width="400" height="300">
        <p><strong>SHARAN</strong></p>
        <p>CEG 3rd year BE</p>
      </div>
    </div>
    <!---<div class="col-sm-4">
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 9080393863 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> sharansuresh0525@gmail.com</p>
    </div>
